...
before_figs = {APM : {street :go.Bar(
                                x = times.loc[(times['corridor'] == street) & (times['mon'] <= middate) & (times['time_period'] == APM)]['dir']
...
after_figs = {APM : {street :go.Bar(
                                x = times.loc[(times['corridor'] == street) & (times['mon'] >= middate) & (times['time_period'] == APM)]['dir'],
                                y = times.loc[(times['corridor'] == street) & (times['mon'] >= middate) & (times['time_period'] == APM)]['travel_time'],
                                name = 'After',
